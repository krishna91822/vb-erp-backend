...
router.patch("/status", hasPermission("update_on_CIMS_module"), setStatus);
router.patch("/", hasPermission("update_on_CIMS_module"), cimsPatch);

/* ************************************************** */
// new filter for PMO integration
router.get(
  "/filterclients",
  hasPermission("view_CIMS_module"),
  getFilteredClients
);
router.get(
  "/filterclients/:id",
